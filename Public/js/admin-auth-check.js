// Admin Authentication System - Updated and Working
...
class AuthCheck {
    constructor() {
        ...
        console.log('🔧 AuthCheck constructor called');
    }
    ...
    async checkAuth() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Handle different possible role field names and default to admin for admin pages
    ...
    isAdmin() {
        ...
        const result = adminRoles.includes(this.userType) || this.isAuthenticated;
        console.log('🔐 isAdmin check:', result, 'userType:', this.userType, 'isAuthenticated:', this.isAuthenticated);
        console.log('🔐 adminRoles:', adminRoles);
        console.log('🔐 userType in adminRoles:', adminRoles.includes(this.userType));
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (currentPage.includes('admin') && !currentPage.includes('login')) {
        ...
        // Prevent infinite redirects by checking if we just came from login
        const urlParams = new URLSearchParams(window.location.search);
        const fromLogin = urlParams.get('from') === 'login';
        console.log('🔄 Coming from login?', fromLogin);
